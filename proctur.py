...
X_AXIS_CHEAT = 0
Y_AXIS_CHEAT = 0
ALARM_DURATION = 5  # Duration in seconds before alarm triggers
    ...
    while cap.isOpened():
        ...
        if results.multi_face_landmarks:
            for face_landmarks in results.multi_face_landmarks:
                ...
                if X_AXIS_CHEAT >= ALARM_DURATION * 20 or Y_AXIS_CHEAT >= ALARM_DURATION * 20:
                    alarm_thread = th.Thread(target=play_alarm)
                    alarm_thread.start()
                    X_AXIS_CHEAT = 0
                    Y_AXIS_CHEAT = 0
